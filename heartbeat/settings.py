...
ADMINS = (
    ('Jiaji Wang', 'jiaji.wang@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'heartbeatn',                      # Or path to database file if using sqlite3.
...
MEDIA_URL = 'https://hbbeatimages.s3.amazonaws.com/media/'
...
STATICFILES_DIRS = (
    ...
    ('hbweb', '/home/ubuntu/heartbeat/statics/'),
)
...
SECRET_KEY = '_268$$1o7i4*x4#fbmbpczce9m=zblb6%1k+sbovx49%v%@n0d'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/home/ubuntu/heartbeat/templates',
)
